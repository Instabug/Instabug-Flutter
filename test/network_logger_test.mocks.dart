...
class MockApmHostApi extends _i1.Mock implements _i3.ApmHostApi {
  ...
  @override
  _i4.Future<void> setLogLevel(String? arg_level) => (super.noSuchMethod(
        Invocation.method(
          #setLogLevel,
          [arg_level],
        ),
...
class MockInstabugHostApi extends _i1.Mock implements _i5.InstabugHostApi {
  ...
  @override
  _i4.Future<void> setDebugEnabled(bool? arg_enabled) => (super.noSuchMethod(
        Invocation.method(
          #setDebugEnabled,
          [arg_enabled],
        ),
  ...
  @override
  _i4.Future<void> setSdkDebugLogsLevel(String? arg_level) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<void> setReproStepsMode(String? arg_mode) => (super.noSuchMethod(
        Invocation.method(
          #setReproStepsMode,
          [arg_mode],
        ),
  ...
  @override
  _i4.Future<void> enableAndroid() => (super.noSuchMethod(
        Invocation.method(
          #enableAndroid,
          [],
        ),
  ...
  @override
  _i4.Future<void> disableAndroid() => (super.noSuchMethod(
        Invocation.method(
          #disableAndroid,
          [],
        ),
