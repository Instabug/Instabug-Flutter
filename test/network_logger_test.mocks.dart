...
class _FakeNetworkData_9 extends _i1.Fake implements _i5.NetworkData {}
...
///
/// See the documentation for Mockito's code generation for more information.
class MockHttpClientLogger extends _i1.Mock implements _i6.HttpClientLogger {
  MockHttpClientLogger() {
    _i1.throwOnMissingStub(this);
  }

  @override
  Map<int, _i5.NetworkData> get requests =>
      (super.noSuchMethod(Invocation.getter(#requests),
          returnValue: <int, _i5.NetworkData>{}) as Map<int, _i5.NetworkData>);
  @override
...
class MockHttpClientCredentials extends _i1.Mock
    implements _i2.HttpClientCredentials {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockNetworkLogger extends _i1.Mock implements _i7.NetworkLogger {
  MockNetworkLogger() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<bool?> networkLog(_i5.NetworkData? data) =>
      (super.noSuchMethod(Invocation.method(#networkLog, [data]),
          returnValue: Future<bool?>.value()) as _i4.Future<bool?>);
  @override
  String toString() => super.toString();
}

/// A class which mocks [NetworkData].
///
/// See the documentation for Mockito's code generation for more information.
class MockNetworkData extends _i1.Mock implements _i5.NetworkData {
  MockNetworkData() {
    _i1.throwOnMissingStub(this);
  }
  ...
  String get requestBody =>
      (super.noSuchMethod(Invocation.getter(#requestBody), returnValue: '')
          as String);
  @override
  String get responseBody =>
      (super.noSuchMethod(Invocation.getter(#responseBody), returnValue: '')
          as String);
  @override
  int get requestBodySize =>
      (super.noSuchMethod(Invocation.getter(#requestBodySize), returnValue: 0)
          as int);
  @override
  int get responseBodySize =>
      (super.noSuchMethod(Invocation.getter(#responseBodySize), returnValue: 0)
          as int);
  @override
  ...
  Map<String, dynamic> get responseHeaders =>
      (super.noSuchMethod(Invocation.getter(#responseHeaders),
          returnValue: <String, dynamic>{}) as Map<String, dynamic>);
  @override
  DateTime get startTime => (super.noSuchMethod(Invocation.getter(#startTime),
  ...
  String get errorDomain =>
      (super.noSuchMethod(Invocation.getter(#errorDomain), returnValue: '')
          as String);
  @override
  _i5.NetworkData copyWith(
          {String? url,
          String? method,
          String? requestBody,
          String? responseBody,
      ...
      (super.noSuchMethod(
          ...
          returnValue: _FakeNetworkData_9()) as _i5.NetworkData);
  @override
