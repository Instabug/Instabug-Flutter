...
class MockBugReportingHostApi extends _i1.Mock
  ...
  _i3.Future<void> bindOnDismissCallback() =>
      (super.noSuchMethod(Invocation.method(#bindOnDismissCallback, []),
          ...
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
  _i3.Future<void> setDisclaimerText(String? arg_text) =>
      (super.noSuchMethod(Invocation.method(#setDisclaimerText, [arg_text]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
  _i3.Future<void> setCommentMinimumCharacterCount(
          int? arg_limit, List<String?>? arg_reportTypes) =>
      (super.noSuchMethod(
          Invocation.method(
              #setCommentMinimumCharacterCount, [arg_limit, arg_reportTypes]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
}
