...
- Deprecate execution traces APIs `Instabug.addExperiments`, `Instabug.removeExperiments` and `Instabug.clearAllExperiments` in favor of the new app flow APIs ([#471](https://github.com/Instabug/Instabug-Flutter/pull/471)).
...
- showWelcomeMessageWithMode(WelcomeMessageMode welcomeMessageMode)
  onTrace`, `Instabug.setExecutionTraceAttribute` and `Instabug.endExecutionTrace` in favor of the new app flow APIs ([#471](https://github.com/Instabug/Instabug-Flutter/pull/471)).
