...
class CrashReporting {
  ...
  static Future<void> reportCrash(dynamic exception, StackTrace stack) async {
    if (kReleaseMode && enabled) {
      return _reportUnhandledCrash(exception, stack);
    } else {
  ...
  static Future<void> reportHandledCrash(
    ...
    return _sendCrash(exception, stack ?? StackTrace.current, true);
  }
  ...
  static Future<void> _reportUnhandledCrash(
    ...
    return _sendCrash(exception, stack, false);
  }
