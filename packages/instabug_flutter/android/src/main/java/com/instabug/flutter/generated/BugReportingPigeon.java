  ...
  public interface BugReportingHostApi {
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable BugReportingHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.instabug_flutter.BugReportingHostApi.addUserConsents", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Boolean mandatoryArg = (Boolean) args.get(2);
                Boolean checkedArg = (Boolean) args.get(3);
