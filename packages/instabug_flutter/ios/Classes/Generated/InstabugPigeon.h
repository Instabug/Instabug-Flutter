...
- (void)onNetworkLogBodyMaxSizeChangeNetworkBodyMaxSize:(NSNumber *)networkBodyMaxSize completion:(void (^)(FlutterError *_Nullable))completion;
@end
...
- (void)initToken:(NSString *)token invocationEvents:(NSArray<NSString *> *)invocationEvents debugLogsLevel:(NSString *)debugLogsLevel appVariant:(nullable NSString *)appVariant error:(FlutterError *_Nullable *_Nonnull)error;
...
- (void)setEnableUserStepsIsEnabled:(NSNumber *)isEnabled error:(FlutterError *_Nullable *_Nonnull)error;
- (void)logUserStepsGestureType:(NSString *)gestureType message:(NSString *)message viewName:(nullable NSString *)viewName error:(FlutterError *_Nullable *_Nonnull)error;
...
- (void)setNetworkLogBodyEnabledIsEnabled:(NSNumber *)isEnabled error:(FlutterError *_Nullable *_Nonnull)error;
