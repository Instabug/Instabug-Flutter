...
- (void)onNetworkLogBodyMaxSizeChangeNetworkBodyMaxSize:(NSNumber *)arg_networkBodyMaxSize completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.instabug_flutter.FeatureFlagsFlutterApi.onNetworkLogBodyMaxSizeChange"
      binaryMessenger:self.binaryMessenger
      codec:FeatureFlagsFlutterApiGetCodec()];
...
void InstabugHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<InstabugHostApi> *api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:InstabugHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(initToken:invocationEvents:debugLogsLevel:appVariant:error:)], @"InstabugHostApi api (%@) doesn't respond to @selector(initToken:invocationEvents:debugLogsLevel:appVariant:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.enableAutoMasking"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(enableAutoMaskingAutoMasking:error:)], @"InstabugHostApi api (%@) doesn't respond to @selector(enableAutoMaskingAutoMasking:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.setAppVariant"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setAppVariantAppVariant:error:)], @"InstabugHostApi api (%@) doesn't respond to @selector(setAppVariantAppVariant:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.setEnableUserSteps"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setEnableUserStepsIsEnabled:error:)], @"InstabugHostApi api (%@) doesn't respond to @selector(setEnableUserStepsIsEnabled:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSNumber *arg_isEnabled = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.logUserSteps"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(logUserStepsGestureType:message:viewName:error:)], @"InstabugHostApi api (%@) doesn't respond to @selector(logUserStepsGestureType:message:viewName:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.setNetworkLogBodyEnabled"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setNetworkLogBodyEnabledIsEnabled:error:)], @"InstabugHostApi api (%@) doesn't respond to @selector(setNetworkLogBodyEnabledIsEnabled:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSNumber *arg_isEnabled = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.getNetworkBodyMaxSize"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getNetworkBodyMaxSizeWithCompletion:)], @"InstabugHostApi api (%@) doesn't respond to @selector(getNetworkBodyMaxSizeWithCompletion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.setTheme"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setThemeThemeConfig:error:)], @"InstabugHostApi api (%@) doesn't respond to @selector(setThemeThemeConfig:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.setFullscreen"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setFullscreenIsEnabled:error:)], @"InstabugHostApi api (%@) doesn't respond to @selector(setFullscreenIsEnabled:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSNumber *arg_isEnabled = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
