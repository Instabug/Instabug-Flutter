...
import 'package:instabug_flutter/src/utils/screen_name_masker.dart' as _i7;
...
class MockInstabugHostApi extends _i1.Mock implements _i2.InstabugHostApi {
  ...
  @override
  _i3.Future<void> enableAutoMasking(List<String?>? arg_autoMasking) =>
      (super.noSuchMethod(
        Invocation.method(
          #enableAutoMasking,
          [arg_autoMasking],
  ...
  @override
  _i3.Future<void> setAppVariant(String? arg_appVariant) => (super.noSuchMethod(
        Invocation.method(
          #setAppVariant,
          [arg_appVariant],
        ),
  ...
  @override
  _i3.Future<void> setEnableUserSteps(bool? arg_isEnabled) =>
      (super.noSuchMethod(
        Invocation.method(
          #setEnableUserSteps,
          [arg_isEnabled],
  ...
  @override
  _i3.Future<void> registerFeatureFlagChangeListener() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<Map<String?, bool?>> isW3CFeatureFlagsEnabled() =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<void> setNetworkLogBodyEnabled(bool? arg_isEnabled) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<double?> getNetworkBodyMaxSize() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<void> setTheme(Map<String?, Object?>? arg_themeConfig) =>
      (super.noSuchMethod(
        Invocation.method(
          #setTheme,
          [arg_themeConfig],
  ...
  @override
  _i3.Future<void> setFullscreen(bool? arg_isEnabled) => (super.noSuchMethod(
        Invocation.method(
          #setFullscreen,
          [arg_isEnabled],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockScreenNameMasker extends _i1.Mock implements _i7.ScreenNameMasker {
  MockScreenNameMasker() {
    _i1.throwOnMissingStub(this);
  }

  @override
  void setMaskingCallback(_i7.ScreenNameMaskingCallback? callback) =>
      super.noSuchMethod(
        Invocation.method(
          #setMaskingCallback,
          [callback],
