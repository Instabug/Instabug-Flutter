...
@interface BugReportingFlutterApiCodecReader : FlutterStandardReader
@end
@implementation BugReportingFlutterApiCodecReader
@end

@interface BugReportingFlutterApiCodecWriter : FlutterStandardWriter
@end
@implementation BugReportingFlutterApiCodecWriter
@end

@interface BugReportingFlutterApiCodecReaderWriter : FlutterStandardReaderWriter
@end
@implementation BugReportingFlutterApiCodecReaderWriter
- (FlutterStandardWriter *)writerWithData:(NSMutableData *)data {
  return [[BugReportingFlutterApiCodecWriter alloc] initWithData:data];
}
- (FlutterStandardReader *)readerWithData:(NSData *)data {
  return [[BugReportingFlutterApiCodecReader alloc] initWithData:data];
}
@end

NSObject<FlutterMessageCodec> *BugReportingFlutterApiGetCodec() {
  static dispatch_once_t sPred = 0;
  static FlutterStandardMessageCodec *sSharedObject = nil;
  dispatch_once(&sPred, ^{
    BugReportingFlutterApiCodecReaderWriter *readerWriter = [[BugReportingFlutterApiCodecReaderWriter alloc] init];
...
- (void)onSdkInvokeWithCompletion:(void(^)(NSError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.BugReportingFlutterApi.onSdkInvoke"
...
- (void)onSdkDismissDismissType:(NSString *)arg_dismissType reportType:(NSString *)arg_reportType completion:(void(^)(NSError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.BugReportingFlutterApi.onSdkDismiss"
      binaryMessenger:self.binaryMessenger
      codec:BugReportingFlutterApiGetCodec()];
...
@end
@interface BugReportingHostApiCodecReader : FlutterStandardReader
@end
@implementation BugReportingHostApiCodecReader
@end

@interface BugReportingHostApiCodecWriter : FlutterStandardWriter
@end
@implementation BugReportingHostApiCodecWriter
@end

@interface BugReportingHostApiCodecReaderWriter : FlutterStandardReaderWriter
@end
@implementation BugReportingHostApiCodecReaderWriter
- (FlutterStandardWriter *)writerWithData:(NSMutableData *)data {
  return [[BugReportingHostApiCodecWriter alloc] initWithData:data];
}
- (FlutterStandardReader *)readerWithData:(NSData *)data {
  return [[BugReportingHostApiCodecReader alloc] initWithData:data];
}
@end

NSObject<FlutterMessageCodec> *BugReportingHostApiGetCodec() {
  static dispatch_once_t sPred = 0;
  static FlutterStandardMessageCodec *sSharedObject = nil;
  dispatch_once(&sPred, ^{
    BugReportingHostApiCodecReaderWriter *readerWriter = [[BugReportingHostApiCodecReaderWriter alloc] init];
    sSharedObject = [FlutterStandardMessageCodec codecWithReaderWriter:readerWriter];
  });
  return sSharedObject;
}
...
void BugReportingHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<BugReportingHostApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setEnabled"
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.show"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setInvocationEvents"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setReportTypes"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setExtendedBugReportMode"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setInvocationOptions"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setFloatingButtonEdge"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setVideoRecordingFloatingButtonPosition"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setShakingThresholdForiPhone"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setShakingThresholdForiPad"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setShakingThresholdForAndroid"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setEnabledAttachmentTypes"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.bindOnInvokeCallback"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.bindOnDismissCallback"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setDisclaimerText"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.BugReportingHostApi.setCommentMinimumCharacterCount"
        binaryMessenger:binaryMessenger
        codec:BugReportingHostApiGetCodec()        ];
    if (api) {
