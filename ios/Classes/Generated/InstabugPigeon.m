...
void InstabugHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<InstabugHostApi> *api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.setDebugEnabled"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.setSdkDebugLogsLevel"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.setReproStepsMode"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:InstabugHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setReproStepsConfigBugMode:crashMode:error:)], @"InstabugHostApi api (%@) doesn't respond to @selector(setReproStepsConfigBugMode:crashMode:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSString *arg_bugMode = GetNullableObjectAtIndex(args, 0);
        NSString *arg_crashMode = GetNullableObjectAtIndex(args, 1);
        FlutterError *error;
        [api setReproStepsConfigBugMode:arg_bugMode crashMode:arg_crashMode error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.enableAndroid"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.instabug_flutter.InstabugHostApi.disableAndroid"
        binaryMessenger:binaryMessenger
        codec:InstabugHostApiGetCodec()];
    if (api) {
