...
public class InstabugPigeon {
  ...
  public interface InstabugHostApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, InstabugHostApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.InstabugHostApi.init", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ...
              if (debugLogsLevelArg == null) {
                throw new NullPointerException("debugLogsLevelArg unexpectedly null.");
              }
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.InstabugHostApi.setFont", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ...
              if (fontArg == null) {
                throw new NullPointerException("fontArg unexpectedly null.");
              }
              api.setFont(fontArg);
              wrapped.put("result", null);
            }
